...
export async function GET() {
  try {
    ...
    // Get only Collection section products
    ...
    console.error('GET /api/products/collection error:', e)
...
export async function POST(req) {
  try {
    ...
    const created = await Product.create({
      name, 
      category, 
      section: 'collection', // Explicitly set section
      price: priceNum, 
      img, 
    ...
    console.error('POST /api/products/collection error:', e)
