...
export async function GET() {
  try {
    ...
    // Get only Marketplace section products
    ...
    console.error('GET /api/products/marketplace error:', e)
...
export async function POST(req) {
  try {
    ...
    const created = await Product.create({
      name, 
      category, 
      section: 'marketplace', // Explicitly set section
      price: priceNum, 
      img, 
    ...
    console.error('POST /api/products/marketplace error:', e)
